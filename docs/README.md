...
| [wakeword-and-routing.md](wakeword-and-routing.md) | ウェイクワード検出の詳細、ツール呼び出しを誰が判断しているか、デプロイで何がどこに載るか |
...
| [slides/](slides/) | 発表スライド（Marp）。プロジェクト紹介 5〜10分 |
...
音声入力とツール呼び出しの内側を詳しく追うなら **wakeword-and-routing.md**。
